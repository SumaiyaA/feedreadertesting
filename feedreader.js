...
$(function() {
    ...
    describe('Initial Entries', function() {
        ...
        it('at least single feed entry displayed', function() {
            expect($('.feed .entry').length).toBeGreaterThan(0);
        });
    });


    //test a new feed is loaded
    describe('New Feed Selection', function() {
        ...
        var entry1,
            entry2;
        beforeEach(function(done) {
            //sure the asyn function loadFeed has completed and its run the test
            loadFeed(0, function() {
        ...
        it('loadFeed content changes', function(done) {
            //to compare the value of the second entry to the first
            loadFeed(1, function() {
                //the value of the second entry
                entry2 = $('.feed').html();
                //Compares the value of the second to the first they are not the same
